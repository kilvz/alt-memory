#!/usr/bin/env python3
"""
spellcheck.py — Spell-correct user messages before dimension filing.
...
# CamelCase: ChromaDB, AltMemory, LongMemEval
...
if __name__ == "__main__":
    test_cases = [
        ...
        "AltMemory cant be fine-tuned if you already know the question",
    ...
    for msg in test_cases:
        result = spellcheck_user_text(msg, known_names={"riley", "sam", "alt-memory"})
