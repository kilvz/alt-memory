...
SYSTEM_PROMPT = """You are helping organize a user's memory dimension by classifying capitalized tokens found in their files.
...
def collect_corpus_text(
    ...
    from alt_memory.entity_detector import PROSE_EXTENSIONS, SKIP_DIRS
