...
``alt_memory.backends`` entry point. Explicit registration wins on
...
from alt_memory.backends.base import BaseBackend

logger = logging.getLogger(__name__)

_ENTRY_POINT_GROUP = "alt_memory.backends"
...
def resolve_backend_for_dimension(
    *,
